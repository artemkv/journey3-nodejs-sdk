export const createSessionHeader = (accountId, appId, version, isRelease, getNowUtc, getNewId) => {
    if (!accountId) {
...
export const createSession = (id, accountId, appId, version, isRelease, start, getNowUtc) => {
    if (!id) {
